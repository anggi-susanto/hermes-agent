...
def telegram_bot_commands() -> list[tuple[str, str]]:
    ...
    an incomplete command. Configured quick commands are appended so the
    Telegram slash menu can advertise runtime shortcuts like ``/ccinspect``.
    ...
    for raw_tg_name, description in _quick_command_telegram_menu_entries():
        tg_name = _sanitize_telegram_name(raw_tg_name)
        if not tg_name or tg_name in seen:
            continue
