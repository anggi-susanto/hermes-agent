...
DEFAULT_CONFIG = {
    ...
    "memory": {
        ...
        # Set to a provider name to activate: "honcho", "letta", "openviking",
...
OPTIONAL_ENV_VARS = {
    ...
    "AWS_ACCESS_KEY_ID": {
        "description": "AWS access key ID for native Bedrock provider",
    ...
    "AWS_SECRET_ACCESS_KEY": {
        "description": "AWS secret access key for native Bedrock provider",
    ...
    "AWS_SESSION_TOKEN": {
        "description": "Optional AWS session token for native Bedrock provider",
    ...
    "AWS_REGION": {
        "description": "AWS region for native Bedrock provider",
        "prompt": "AWS region",
        "url": None,
        "password": False,
        "category": "provider",
    ...
    "AWS_PROFILE": {
        "description": "Optional AWS shared config profile for native Bedrock provider",
        "prompt": "AWS profile",
        "url": None,
        "password": False,
        "category": "provider",
    ...
    "AWS_DEFAULT_REGION": {
        "description": "Fallback AWS region for native Bedrock provider",
        "prompt": "AWS default region",
        "url": None,
        "password": False,
        "category": "provider",
        "advanced": True,
    ...
    "BEDROCK_MODEL_ID": {
        "description": "Default AWS Bedrock model ID",
