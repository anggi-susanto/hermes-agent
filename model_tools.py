...
def get_tool_definitions(
    ...
    if quiet_mode:
        ...
        try:
            from tools.registry import get_check_fn_cache_generation
            check_fn_generation = get_check_fn_cache_generation()
        except Exception:
            check_fn_generation = None
        try:
            availability_fp = registry.get_availability_fingerprint()
        except Exception:
            availability_fp = None
        cache_key = (*cache_key, check_fn_generation, availability_fp)
