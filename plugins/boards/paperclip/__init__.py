...
PAPERCLIP_API_BASE_URL = "https://paperclip.ing/api"
PAPERCLIP_WEB_BASE_URL = "https://paperclip.ing"
PAPERCLIP_API_KEY_ENV_VARS = ("PAPERCLIP_API_KEY",)
...
class PaperclipBoardProvider:
    ...
    def __init__(
        ...
        self.api_base_url = (api_base_url or PAPERCLIP_API_BASE_URL).rstrip("/")
    ...
    def _resolve_api_key(self, connection: BoardConnection) -> str:
        ...
        if raw_key:
            return str(raw_key)
        for env_var in PAPERCLIP_API_KEY_ENV_VARS:
...
def register(ctx) -> None:
    ctx.register_board_provider(
        ...
        name="Paperclip",
        auth_type="api_key",
        api_base_url=PAPERCLIP_API_BASE_URL,
        web_base_url=PAPERCLIP_WEB_BASE_URL,
        api_key_env_vars=PAPERCLIP_API_KEY_ENV_VARS,
