...
def _sync_discord_module_global():
    ...
    discord_mod.DMChannel = FakeDMChannelBase
...
class FakeDMChannelBase:
    """Stable base that the test and adapter mock both share."""


class FakeDMChannel(FakeDMChannelBase):
