...
class TestSecurityScanGate:
    ...
    def test_scan_warns_dangerous_when_flag_on(self, tmp_path, caplog):
        """Dangerous ask verdict + flag on warns but stays non-blocking for agents."""
        from tools.skill_manager_tool import _security_scan_skill
        ...
        assert result is None
        assert "Agent-created skill has security findings" in caplog.text
